...
<html>
<head>
	<title>MFAS - MULTI FINANCE APPLICATION SYSTEM</title>
	...
	<script type="text/javascript" src="<?php echo config_item('base_js');?>masterkewenangan.js?cb=<?php echo time()?>"></script>
</head>
<body>
</body>
</html>